...
- If you have already provided a complete, working solution that fulfills the core task requirements, you MUST:
  1. First, provide the COMPLETE, FINAL version of the code in your response (include the entire function implementation, not just a reference to earlier code)
